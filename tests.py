...
class TestInialiser(unittest.TestCase):
    ...
    def testReadFileBuildingSurfaceDetailed(self):
        self.assertEqual('BuildingSurface:Detailed,Floor0.Zone0,Floor,GroundFloor,Zone0,Ground,,NoSun,NoWind,0,4,13.5,0.0,0.0,26.23438,7.35156,0.0,12.73438,30.73438,0.0,0.0,23.375,0.0;', str(self.idfObjects['BuildingSurface:Detailed'][0]))
    ...
    def testReadFileMaterial(self):
        self.assertEqual("Material,Brick.Wall,Smooth,0.18,2.3,2300,1100,0.9,0.7,0.7;",  str(self.idfObjects['Material'][0]))
